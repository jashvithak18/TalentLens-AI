...
const JobSearch = ({ defaultTab = 'search' }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-white">Talent Gateway</h1>
      ...
      {errorMsg && (
        <div className="bg-rose-950/40 border border-rose-500/20 text-rose-400 text-xs rounded-lg p-3.5 flex items-center space-x-2">
          <AlertCircle size={16} />
          <span>{errorMsg}</span>
        </div>
      )}
