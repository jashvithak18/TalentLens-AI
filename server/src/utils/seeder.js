    ...
    const candidatesData = [
      {
        ...
        experience: [{ company: 'InnoTech Solutions', role: 'Full Stack Engineer', startDate: new Date('2022-03-01'), current: true, description: 'Re-architected candidate pipeline resulting in 40% performance gain.' }],
        education: [{ institution: 'Stanford University', degree: 'Bachelor of Science', fieldOfStudy: 'Computer Science', grade: 'GPA 3.8' }],
        projects: [{ title: 'E-Commerce Platform Microservice', description: 'A scalable checkout api service using JWT and Stripe gateway.', technologies: ['Node.js', 'Express.js', 'MongoDB', 'JWT'] }],
        score: 100,
        matchScore: 94,
      ...
      },
      {
        ...
        bio: 'Frontend developer focused on building pixel-perfect responsive user interfaces and robust design systems.',
        experience: [{ company: 'WebFlow Agency', role: 'Frontend Developer', startDate: new Date('2023-01-01'), current: true, description: 'Built complex dashboards using Tailwind and React.' }],
        education: [{ institution: 'New York University', degree: 'Bachelor of Arts', fieldOfStudy: 'Interactive Design', grade: 'GPA 3.6' }],
      ...
      {
        name: 'Brandon Chen',
        email: 'brandon.chen@example.com',
        ...
        experience: [{ company: 'DataCore Labs', role: 'ML Engineer', startDate: new Date('2021-06-01'), current: true, description: 'Engineered analytics engines running on Python FastAPI.' }],
        education: [{ institution: 'UC Berkeley', degree: 'Bachelor of Science', fieldOfStudy: 'Computer Science & Data', grade: 'GPA 3.9' }],
      ...
      },
      {
        ...
        bio: 'Detail-oriented QA engineer dedicated to end-to-end integration testing and automated release pipelines.',
        experience: [{ company: 'QualityFirst', role: 'Test Automation Lead', startDate: new Date('2022-02-01'), current: true, description: 'Decreased production bug leakage by 35% using Cypress.' }],
        education: [{ institution: 'University of Texas', degree: 'Bachelor of Science', fieldOfStudy: 'Software Engineering', grade: 'GPA 3.5' }],
      ...
      },
      {
        ...
        bio: 'Infrastructure specialist building robust, scalable cloud architectures and automated pipelines.',
        experience: [{ company: 'CloudWorks', role: 'DevOps Architect', startDate: new Date('2020-09-01'), current: true, description: 'Migrated monolithic app to Kubernetes cluster.' }],
        education: [{ institution: 'Colorado State', degree: 'B.S.', fieldOfStudy: 'Computer Engineering', grade: 'GPA 3.4' }],
      ...
      },
      {
        ...
        bio: 'High-performance API developer focusing on low-latency microservices and database clustering.',
        experience: [{ company: 'CoreSystems', role: 'Backend Dev', startDate: new Date('2021-01-01'), current: true, description: 'Optimized sql queries reducing response time by 50%.' }],
        education: [{ institution: 'Boston University', degree: 'M.S.', fieldOfStudy: 'Computer Science', grade: 'GPA 3.7' }],
      ...
      },
      {
        ...
        bio: 'Bridging the gap between gorgeous designs and scalable front-end code bases.',
        experience: [{ company: 'CreativeTech', role: 'UI Engineer', startDate: new Date('2023-03-01'), current: true, description: 'Designed and implemented main landing flows.' }],
        education: [{ institution: 'ArtCenter College', degree: 'Bachelor of Fine Arts', fieldOfStudy: 'Graphic Design', grade: 'GPA 3.8' }],
      ...
      },
      {
        ...
        bio: 'Self-taught developer with high curiosity and motivation to scale development capabilities.',
        experience: [{ company: 'Local Startups', role: 'Contractor', startDate: new Date('2025-05-01'), current: true, description: 'Helped bootstrap startup components.' }],
        education: [{ institution: 'Self Taught / Coursera', degree: 'N/A', fieldOfStudy: 'Software Development Certificate', grade: 'Pass' }],
      ...
      },
      {
        ...
        bio: 'Secure coding evangelist building hardened APIs and tracking security patches.',
        experience: [{ company: 'SecureNet', role: 'Security Dev', startDate: new Date('2023-05-01'), current: true, description: 'Reviewed secure code and automated vulnerability scans.' }],
        education: [{ institution: 'Drexel University', degree: 'B.S.', fieldOfStudy: 'Cybersecurity', grade: 'GPA 3.6' }],
      ...
      {
        name: 'Akihiro Tanaka',
        email: 'akihiro.tanaka@example.com',
        title: 'Senior Systems Programmer',
        location: 'Seattle, WA',
        skills: ['C++', 'Rust', 'WebAssembly', 'Linux', 'Docker', 'SQL', 'Algorithms'],
        bio: '8+ years engineer developing low-level network routers and high-performance WebAssembly engines.',
        experience: [{ company: 'SysCore Labs', role: 'Principal Programmer', startDate: new Date('2018-01-01'), current: true, description: 'Led core network router codebase development.' }],
        education: [{ institution: 'University of Washington', degree: 'M.S.', fieldOfStudy: 'Computer Science', grade: 'GPA 3.9' }],
      ...
      },
      {
        ...
        bio: 'Recent bootcamp graduate looking to apply full stack javascript skills to dynamic web apps.',
        experience: [{ company: 'Freelance', role: 'Web Developer', startDate: new Date('2025-08-01'), current: true, description: 'Built landing pages and API mocks.' }],
        education: [{ institution: 'Atlanta Tech Bootcamp', degree: 'Certificate', fieldOfStudy: 'Full Stack Web Dev', grade: 'Pass' }],
      ...
      },
      {
        ...
        bio: 'Mobile enthusiast building cross-platform native iOS and Android apps with beautiful widgets.',
        experience: [{ company: 'MobileScale', role: 'App Developer', startDate: new Date('2023-06-01'), current: true, description: 'Shipped 3 React Native apps to Apple Store.' }],
        education: [{ institution: 'Florida State', degree: 'B.S.', fieldOfStudy: 'Computer Science', grade: 'GPA 3.5' }],
